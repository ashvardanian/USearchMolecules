...
![USearchMolecules Thumbnail](https://github.com/ashvardanian/ashvardanian/blob/master/repositories/USearchMolecules.jpg?raw=true)

__USearchMolecules__ is a large Chem-Informatics dataset of small molecules.
...
| `n_conformers`       | `uint8`       | 1 B          | Conformers kept after RMSD deduplication.                |
